$(document).ready(function() {
    ...
    $('.il-select2').select2({
        ...
        tags: true // Bunu bilmiyorum hep vardı :D
    });
...
function set_select2_multiple_icerik(select2_obj) {
        var uldiv = $('.'+select2_obj).next('span.select2').find('ul');
    ...
    $.ajax({
        ...
        success: function(result){
            if (result == "login-error") {
                document.getElementById('message-box').value = "Giriş Başarısız!";
                $('#message-box').addClass("message-box-error");
            } else if (result == "login-success") {
                document.getElementById('message-box').value = "Hoşgeldiniz!";
