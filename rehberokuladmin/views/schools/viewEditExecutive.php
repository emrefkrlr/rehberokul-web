...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/editExecutive/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select data-plugin-selectTwo class="form-control populate"  disabled data-plugin-search  data-plugin-options='{ "maxHeight": 200 }' id="school_type" name="school_type">
                        ...
                        <option <?php echo $viewModel['type'] == 1 ? 'selected' : ''; ?> value="1">Anaokulu veya Kreş</option>
                        ...
                        <option <?php echo $viewModel['type'] == 4 ? 'selected' : ''; ?> value="4">Lise</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group" <?php echo $viewModel['type'] == 1 ? '' : 'style="display: none;"'; ?>>
                <label class="col-md-3 control-label" for="start_age">
                    Yaş Aralığı
                    <span class="required" aria-required="true">*</span>
                </label>
                <div class="col-md-2">
                    <input type="text" <?php echo $viewModel['type'] == 1 ? 'required' : ''; ?> class="form-control col-md-2" id="start_age" name="start_age" pattern="[0-9\s]*"  title='Yaş Aralığı İçin Sadece Rakam Kullanılabilir!' value="<?php echo trim(explode('-',$viewModel['age_interval'])[0]); ?>"/>
                </div>
                <div class="col-md-2 center text-weight-bold">---</div>
                <div class="col-md-2">
                    <input type="text" <?php echo $viewModel['type'] == 1 ? 'required' : ''; ?> class="form-control col-md-2" id="end_age" name="end_age" pattern="[0-9\s]*"  title='Yaş Aralığı İçin Sadece Rakam Kullanılabilir!' value="<?php echo trim(explode('-',$viewModel['age_interval'])[1]); ?>"/>
                </div>
