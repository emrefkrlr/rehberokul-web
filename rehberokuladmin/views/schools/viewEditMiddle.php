...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/editMiddle/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="price" name="price" pattern="[0-9]*"  title='Ortalama Aylık Ücret Sadece Rakam Kullanılabilir!' value="<?php echo $viewModel['price']; ?>"/>
