    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/edit/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?php echo $viewModel['link'] == $_SESSION['user_data']['link'] ? 'hide' : '';?>" >
                        ...
                        <div class="col-md-6">
                                <select onchange="visible_schools()"data-plugin-selectTwo class="form-control populate" name='role' id="roles_select" required>
                    ...
                    <div class="form-group">
                            <div class="center">
                                <button type="submit" name="submit" class="btn btn-primary">Güncelle</button>
                                    <a href="<?php echo strtolower(get_class($this)).'/all_users';?>"><button type="button" class="btn btn-default">Kapat</button></a>
                            </div>
                    </div>
