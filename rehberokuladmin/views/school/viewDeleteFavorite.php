...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/deleteFavorite/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" <?php echo $viewModel['type'] == 1 ? '' : 'display:"none;"';?>>
                <label class="col-md-3 control-label" for="start_age">
                    Yaş Aralığı
                    <span class="required" aria-required="true">*</span>
                </label>
                <div class="col-md-2">
                    <input type="text" class="form-control col-md-2" id="start_age" name="start_age" value="<?php echo trim(explode('-',$viewModel['age_interval'])[0]); ?>" disabled/>
                </div>
                <div class="col-md-2 center text-weight-bold">---</div>
                <div class="col-md-2">
                    <input type="text" class="form-control col-md-2" id="end_age" name="end_age" value="<?php echo trim(explode('-',$viewModel['age_interval'])[1]); ?>" disabled/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select data-plugin-selectTwo class="form-control populate" disabled data-plugin-search  data-plugin-options='{ "maxHeight": 200 }' id="discount" name="discount">
                        <option value="">Seçiniz</option>
                        <option value="1" <?php echo $viewModel['discount']=='1' ? 'selected' : '';?>>Var</option>
                        <option value="2" <?php echo $viewModel['discount']=='2' ? 'selected' : '';?>>Yok</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="center">
                    <button type="submit" name="submit" class="btn btn-danger">Kaldır</button>
                    <a href="<?php echo strtolower(get_class($this)).'/favorite';?>"><button type="button" class="btn btn-default">Geri Dön</button></a>
                </div>
            </div>
