...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo strtolower(get_class($this)).'/deleteMiddle/'.$viewModel['link']; ?>" enctype="multipart/form-data">
