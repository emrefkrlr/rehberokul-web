    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/editMiddle/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" id="servc_div" <?php echo $viewModel['transportation'] == 1 ? '' : 'style="display: none;"'; ?>>
                ...
                <div class="col-md-6">
                    <select data-plugin-selectTwo class="form-control populate" <?php echo $viewModel['transportation'] == 1 ? 'required' : ''; ?> multiple="multiple" data-plugin-search  data-plugin-options='{ "maxHeight": 200 }' id="servc" name="servc[]">
                        <?php foreach($sm::$towns as $town): ?>
