<?php $ssm = new SchoolModel();?>
<section class="panel panel-primary">
    <header class="panel-heading">
        <h2 class="panel-title"><?php echo Controller::$title.'me Formu';?></h2>
    </header>
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/editKindergarten/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select required title="Şehir Seçmediniz!" onchange="set_towns()" data-plugin-selectTwo class="form-control populate" name='city' id="city">
                        ...
                        <?php foreach($ssm::$cities as $cits): ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select data-plugin-selectTwo required title="Mahalle Seçmediniz!" class="form-control populate" name='subtown' id="subtown">
                        <option value="">Seçiniz</option>
                        <?php foreach($ssm::$subtowns as $subtown): ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <input type="text" class="form-control col-md-2" id="start_age" name="start_age" pattern="[0-9\s]*"  title='Yaş Aralığı İçin Sadece Rakam Kullanılabilir!' value="<?php echo trim(explode('-',$viewModel['age_interval'])[0]); ?>" required/>
                </div>
                <div class="col-md-2 center text-weight-bold">---</div>
                <div class="col-md-2">
                    <input type="text" class="form-control col-md-2" id="end_age" name="end_age" pattern="[0-9\s]*"  title='Yaş Aralığı İçin Sadece Rakam Kullanılabilir!' value="<?php echo trim(explode('-',$viewModel['age_interval'])[1]); ?>" required/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-icon">
                        ...
                        <input style="margin-left: 110px; width: 100px;" value="<?php echo $ssm::$school_hours['monday_start'];?>" required title="Pazartesi Günü İçin Başlangıç Saati Girmediniz!" name="monday_start" id="monday_start"  type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>

                        <span class="input-group-addon">
                                <span class="icon">Pzt Bitiş</span>
                            </span>
                        <input style="margin-left: 80px; width: 100px;" value="<?php echo $ssm::$school_hours['monday_end'];?>" required title="Pazartesi Günü İçin Bitiş Saati Girmediniz!" name="monday_end" id="monday_end" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>
                    </div>
                    <div class="input-group input-group-icon">
                                <span class="input-group-addon">
                                    <span class="icon">Sal Başlangıç</span>
                                </span>
                        <input style="margin-left: 110px; width: 100px;" value="<?php echo $ssm::$school_hours['tuesday_start'];?>" required title="Salı Günü İçin Başlangıç Saati Girmediniz!" name="tuesday_start" id="tuesday_start" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>

                        <span class="input-group-addon">
                                    <span class="icon">Sal Bitiş</span>
                                </span>
                        <input style="margin-left: 80px; width: 100px;" value="<?php echo $ssm::$school_hours['tuesday_end'];?>" required title="Salı Günü İçin Bitiş Saati Girmediniz!" name="tuesday_end" id="tuesday_end" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>
                    </div>
                    <div class="input-group input-group-icon">
                                    <span class="input-group-addon">
                                        <span class="icon">Çrş Başlangıç</span>
                                    </span>
                        <input style="margin-left: 110px; width: 100px;" value="<?php echo $ssm::$school_hours['wednesday_start'];?>" required title="Çarşamba Günü İçin Başlangıç Saati Girmediniz!" name="wednesday_start" id="wednesday_start" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>

                        <span class="input-group-addon">
                                        <span class="icon">Çrş Bitiş</span>
                                    </span>
                        <input style="margin-left: 80px; width: 100px;" value="<?php echo $ssm::$school_hours['wednesday_end'];?>" required title="Çarşamba Günü İçin Bitiş Saati Girmediniz!" name="wednesday_end" id="wednesday_end" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>
                    </div>
                    <div class="input-group input-group-icon">
                                    <span class="input-group-addon">
                                        <span class="icon">Prş Başlangıç</span>
                                    </span>
                        <input style="margin-left: 110px; width: 100px;" value="<?php echo $ssm::$school_hours['thursday_start'];?>" required title="Perşembe Günü İçin Başlangıç Saati Girmediniz!" name="thursday_start" id="thursday_start" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>

                        <span class="input-group-addon">
                                        <span class="icon">Prş Bitiş</span>
                                    </span>
                        <input style="margin-left: 80px; width: 100px;" value="<?php echo $ssm::$school_hours['thursday_end'];?>" required title="Perşembe Günü İçin Bitiş Saati Girmediniz!" name="thursday_end" id="thursday_end"  type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>
                    </div>
                    <div class="input-group input-group-icon">
                                    <span class="input-group-addon">
                                        <span class="icon">Cum Başlangıç</span>
                                    </span>
                        <input style="margin-left: 110px; width: 100px;" value="<?php echo $ssm::$school_hours['friday_start'];?>" required title="Cuma Günü İçin Başlangıç Saati Girmediniz!" name="friday_start" id="friday_start" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>

                        <span class="input-group-addon">
                                        <span class="icon">Cum Bitiş</span>
                                    </span>
                        <input style="margin-left: 80px; width: 100px;" value="<?php echo $ssm::$school_hours['friday_end'];?>" required title="Cuma Günü İçin Bitiş Saati Girmediniz!" name="friday_end" id="friday_end" type="text" data-plugin-timepicker class="form-control" data-plugin-options='{ "showMeridian": false }'>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select style="width: 415px;" title="Servis Bölgesi Seçmediniz!" data-plugin-selectTwo class="form-control populate" onchange="check_service()" required title="Servis Durumunu Seçmediniz!" data-plugin-search  data-plugin-options='{ "maxHeight": 200 }' id="service" name="service">
                        <option value="">Seçiniz</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select required title="İmkanlar Seçilmedi!" data-plugin-selectTwo class="form-control populate" multiple="multiple" data-plugin-search  data-plugin-options='{ "maxHeight": 200 }' id="facs" name="facs[]">
                        ...
                        <?php foreach($ssm::$facility_types as $types): ?>
                            <optgroup label="<?php echo $types['name'] ?>">
                                <?php foreach($ssm::$facilities as $facs): ?>
                                    <?php if($facs['type']==$types['id']): ?>
                                        <option value="<?php echo $facs['id']; ?>" <?php  foreach($ssm::$school_facilities as $sfacility) { echo $facs['id'] == $sfacility['facility_id']  ? 'selected' : '';}?> >
                                            <?php echo $facs['name'];?>
                                        </option>
                                    <?php endif; ?>
                                <?php endforeach; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="content" value=" <?php echo $viewModel['description']; ?>" id="hidden-field" />
                </div>
            </div>
            ...
            <div class="form-group" id="servc_div" <?php echo $viewModel['transportation'] == 1 ? '' : 'style="display: none;"'; ?>>
                ...
                <div class="col-md-6">
                    <select data-plugin-selectTwo <?php echo $viewModel['transportation'] == 1 ? 'required' : '' ?> class="form-control populate" multiple="multiple" data-plugin-search  data-plugin-options='{ "maxHeight": 200 }' id="servc" name="servc[]">
                        <?php foreach($ssm::$towns as $town): ?>
                            <option value="<?php echo $town['ilce_key']; ?>" <?php  foreach($ssm::$transportation_points as $tpoints) { echo $town['ilce_key'] == $tpoints['ilce_key']  ? 'selected' : '';}?>><?php echo $town['name'];?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select  data-plugin-selectTwo class="form-control populate" name='gallery' id="gallery">
                        <option value="">Seçiniz</option>
                        <?php foreach($ssm::$galleries as $gals): ?>
                            <option value="<?php echo $gals['id']; ?>" <?php echo $ssm::$school_galleries['gallery_id'] == $gals['id'] ? 'selected' : ''; ?>><?php echo $gals['name'];?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group <?php echo $_SESSION['user_data']['role'] != 'Yönetici' ? 'hide' : '';?>">
                ...
                <div class="col-md-6">
                    <select title="Kurum Sahibi Seçmediniz!" <?php echo $_SESSION['user_data']['role'] == 'Yönetici' ? 'required' : '';?>  data-plugin-selectTwo class="form-control populate" name='owner' id="owner">
                        ...
                        <?php foreach($ssm::$users as $u): ?>
                            <option value="<?php echo $u['id']; ?>"  <?php echo $ssm::$school_owner['user_id'] == $u['id'] ? 'selected' : ''; ?>><?php echo $u['first_name'].' '.$u['last_name'];?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
