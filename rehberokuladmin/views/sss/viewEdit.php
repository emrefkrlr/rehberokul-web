    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/edit/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select onchange="set_visible_sss_place()" data-plugin-selectTwo class="form-control populate" required title="SSS Yeri Seçiniz!" data-plugin-search  data-plugin-options='{ "maxHeight": 200 }' id="sss_place" name="sss_place">
                        ...
                        <option <?php echo $viewModel['sss_place'] ?> value="okul-detay"><?= $viewModel['sss_place'] ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" required class="form-control" id="question" name="question" title='Soru Girmediniz!' value="<?php echo $viewModel['question']; ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <textarea type="text" class="form-control" id="answer" name="answer" title='Cevap Girmediniz!' value="" required rows="4" cols="5"><?php echo $viewModel['answer'];?></textarea>
                </div>
            </div>
