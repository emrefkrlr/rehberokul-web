...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" id="email-form" action="<?php echo strtolower(get_class($this)).'/edit/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
