...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/addParentDemand/'; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo $dm->getUser($_SESSION['user_data']['user_id'])['first_name'].' '.$dm->getUser($_SESSION['user_data']['user_id'])['last_name']; ?>" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="mail" class="form-control" id="email" name="email" value="<?php echo $dm->getUser($_SESSION['user_data']['user_id'])['email'];?>" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $dm->getUser($_SESSION['user_data']['user_id'])['phone'];?>" disabled/>
                </div>
            </div>
