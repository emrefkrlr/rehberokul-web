...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/editParentDemand/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo $dm->getRoleId($viewModel['user_id']) != 1 ? $dm->getUser($viewModel['user_id'])['first_name'].' '.$dm->getUser($viewModel['user_id'])['last_name'] :
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="mail" class="form-control" id="email" name="email" disabled value="<?php echo $dm->getRoleId($viewModel['user_id']) != 1 ? $dm->getUser($viewModel['user_id'])['email'] : $viewModel['email']; ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="phone" name="phone" disabled value="<?php echo $dm->getRoleId($viewModel['user_id']) != 1 ? $dm->getUser($viewModel['user_id'])['phone'] : $viewModel['phone']; ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select data-plugin-selectTwo required title="Fiyat Aralığı Seçmediniz!" class="form-control populate" name='price' id="price">
                        <option value="">Seçiniz</option>
                        <option <?php echo $viewModel['price_interval']== '500 TL - 1500 TL' ? 'selected' : '' ;?> value="500 TL - 1500 TL">500 TL - 1500 TL</option>
                        <option <?php echo $viewModel['price_interval']== '1500 TL - 3000 TL' ? 'selected' : '' ;?> value="1500 TL - 3000 TL">1500 TL - 3000 TL</option>
                        <option <?php echo $viewModel['price_interval']== '3000 TL - 5000 TL' ? 'selected' : '' ;?> value="3000 TL - 5000 TL">3000 TL - 5000 TL</option>
                        <option <?php echo $viewModel['price_interval']== '5000 TL - 10000 TL' ? 'selected' : '' ;?> value="5000 TL - 10000 TL">5000 TL - 10000 TL</option>
                        <option <?php echo $viewModel['price_interval']== '10000 TL - 20000 TL' ? 'selected' : '' ;?> value="10000 TL - 20000 TL">10000 TL - 20000 TL</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="age" name="age" value="<?php echo $viewModel['age']; ?>" pattern="[0-9]*"  title='Yaş İçin Sadece Rakam Kullanılabilir!' required/>
                </div>
            </div>
                    ...
                    <div class="form-group">
                            <div class="center">
                                <button type="submit" name="submit" class="btn btn-primary">Güncelle</button>
                                    <a href="<?php echo strtolower(get_class($this)).'/parent';?>"><button type="button" class="btn btn-default">Geri Dön</button></a>
                            </div>
                    </div>
