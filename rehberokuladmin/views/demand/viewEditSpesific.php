...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/editSpesific/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" id="schools_select_div">
                ...
                <div class="col-md-6">
                    <select multiple style="width: 415px;" data-plugin-selectTwo class="form-control populate" name='school[]'>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <textarea class="form-control" id="note" name="note" value="" rows="4" cols="5"><?php echo $viewModel['note']; ?></textarea>
                </div>
            </div>
