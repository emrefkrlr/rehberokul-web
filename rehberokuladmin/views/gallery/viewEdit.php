    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/edit/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            <div class="form-group" id="folder" <?php echo $viewModel['isdir'] == 1 ? '' : 'style="display: none;"';?> >
                ...
                <div class="col-md-6">
                    <input <?php echo $viewModel['isdir'] == 1 ? 'required' : '';?> type="text" class="form-control folder" id="folder_name" name="folder_name" value="<?php echo $viewModel['name'];?>"  pattern="[a-zA-Z0-9çÇöÖüÜşŞİığĞ._-\s]*" title='Galeri Adı İçin Büyük harf, küçük harf, rakam veya işaret(._-) kullanabilirsiniz!'/>
                </div>
            </div>
            ...
            <div class="form-group" id="select_folder_div" <?php echo $viewModel['isdir'] != 1 ? '' : 'style="display: none;"';?>>
                ...
                <div class="col-md-6">
                    <select <?php echo $viewModel['isdir'] != 1 ? 'required' : '';?> data-plugin-selectTwo class="form-control populate" style="width: 415px;"  name='select_folder' id="select_folder">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="input-append">
                            ...
                            <span class="btn btn-default btn-file">
                                                            ...
                                                            <input type="file" name="file-haber" id="upload" accept="image/jpg, image/jpeg, image/png" title="Fotoğraf Seçilmedi!"/>
                                                    </span>
            ...
            <div class="form-group" id="photo_name_div" <?php echo $viewModel['isdir'] != 1 ? '' : 'style="display: none;"';?>>
                ...
                <div class="col-md-6 not_folder">
                    <input type="text" <?php echo $viewModel['isdir'] != 1 ? 'required' : '';?> class="form-control" id="photo_name" name="photo_name" value="<?php echo $viewModel['name'];?>" pattern="[a-zA-Z0-9çÇöÖüÜşŞİığĞ._-\s]*" title='Fotoğraf Adı İçin Büyük harf, küçük harf, rakam veya işaret(._-) kullanabilirsiniz!'/>
                </div>
            </div>
