    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo $dm->hideAllDetails($dm->getRoleId($viewModel['user_id']) != 1 ? $dm->getUser($viewModel['user_id'])['first_name'].' '.$dm->getUser($viewModel['user_id'])['last_name'] :
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="mail" class="form-control" id="email" name="email" disabled value="<?php echo $dm->hideAllDetails($dm->getRoleId($viewModel['user_id']) != 1 ? $dm->getUser($viewModel['user_id'])['email'] : $viewModel['email']); ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="phone" name="phone" disabled value="<?php echo $dm->hideAllDetails($dm->getRoleId($viewModel['user_id']) != 1 ? $dm->getUser($viewModel['user_id'])['phone'] : $viewModel['phone']); ?>"/>
                </div>
            </div>
