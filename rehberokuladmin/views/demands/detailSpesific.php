    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo $dm->hideAllDetails($dm->getUser($viewModel['user_id'])['first_name'].' '.$dm->getUser($viewModel['user_id'])['last_name']); ?>" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="mail" class="form-control" id="email" name="email" disabled value="<?php echo $dm->hideAllDetails($dm->getUser($viewModel['user_id'])['email']); ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="phone" name="phone" disabled value="<?php echo $dm->hideAllDetails($dm->getUser($viewModel['user_id'])['phone']); ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="school_type" name="school_type" disabled value="<?php echo $dm->getSchoolTypeBySchoolId($viewModel['school_id']); ?>"/>
                </div>
            </div>
