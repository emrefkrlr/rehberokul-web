...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
            <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/deleteComment/'.$viewModel['link']; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                            <div class="center">
                                ...
                                <a href="<?php echo strtolower(get_class($this)).'/comment';?>"><button type="button" class="btn btn-default">Geri Dön</button></a>
                            </div>
                    </div>
