...
<section class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" method="post" action="<?php echo strtolower(get_class($this)).'/cancel/'.$viewModel['reference_no'].'-'.$viewModel['school_id']; ?>">
            ...
            <div class="form-group">
                <div class="center">
                    <input type="submit" name="submit" class="btn btn-danger" value="İptal Et"/>
