    ...
    <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo strtolower(get_class($this)).'/edit/'.$viewModel['link']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <textarea type="text" class="form-control" id="content" name="content" title='Bildiri Girmediniz!' value="" required rows="4" cols="5"><?php echo $viewModel['content']; ?></textarea>
                </div>
            </div>
            ...
            <div class="form-group" id="send_to_single_div" <?php echo $viewModel['send_type'] == 1 ? 'style="display: none;"' : ''; ?>>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                            <div class="center">
                                <button type="submit" name="submit" class="btn btn-primary">Tekrar Gönder</button>
